...
reg.fit(data[["timePlayed"]],data["kdRatio"])
#reg.predict([[1000]])
...
data.plot.scatter(x="timePlayed", y="kdRatio", ax= ax, color="red", figsize=(12,7))
plt.scatter(x, y, color = 'black')
ax.set(xlabel='Tiempo Jugado(horas)', ylabel='Numero de bajas',
       title='Relacion entre el tiempo de juego de una persona con la cantidad de ')
